package com.example.mlkitfacedetection.facedetection
...
open class FaceBoxOverlay(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        Log.d("FaceBoxOverlay", "onDraw called")
        ...
        synchronized(lock) {
            for (graphic in faceBoxes) {
                ...
                graphic.draw(canvas)
                Log.d("FaceBoxOverlay", "Added FaceBox. Total FaceBoxes: ${faceBoxes.size}")
